...
enable_differential_optimization    = False                                                          # at the end apply differential optimization to the best combination of symmetry_percentage and proportional_lung_capacity
...
segmentation_output_directory       = f"{experiment_name}/segmentation/images"                      #f"try/segmentation/images"
save_intermediate                   = True                                  
segmentation_intermediate_directory = "{experiment_name}/segmentation/intermediate_steps"           #f"try/segmentation/intermediate_steps"
...
symmetry_output_directory           = f"{experiment_name}/symmetry_line/images"                     #f"try/symmetry_line/images"
