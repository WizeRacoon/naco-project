...
labels                          = ["No Finding", 
                                   "Atelectasis"]                           # list of labels (diseases). Possibilities: ["No Finding", "Atelectasis", "Consolidation", "Infiltration", "Pneumothorax", "Edema", "Emphysema", "Fibrosis", "Effusion", "Pneumonia", "Pleural_Thickening", "Cardiomegaly", "Nodule", "Mass", "Hernia"]
...
max_images                          = 1000                               # for if you only want to run a few images
...
symmetry_output_directory           = f"try/symmetry_line/images"
