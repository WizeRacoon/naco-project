...
def plot_symmetry_line(image, symmetry_x, height, width):
...
def calc_lung_symmetry(masked_lung_image_relative_path, show_symmetry_line = False, print_findings = True):
    ...
    if show_symmetry_line:
        plot_symmetry_line(image, symmetry_x, height, width)
